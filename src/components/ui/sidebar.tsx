...
type SidebarMenuButtonProps = (
  | (React.ComponentProps<typeof Link> & { href: string; asChild?: boolean })
...
>(
  (
    ...
    const isActive =
      isActiveProp ?? (props.href ? pathname === props.href : false)
    const Comp = props.href ? Link : asChild ? Slot : "button"

    const button = (
      // @ts-expect-error - This is a valid way to use polymorphic components.
      <Comp
        ref={ref}
